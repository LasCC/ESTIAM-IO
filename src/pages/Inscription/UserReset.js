        ...
        <Grid container spacing={0}>
          <Grid lg={4} md={4} sm={12}>
            ...
            >
              ...
              <Typography variant="subtitle2" style={{ color: "white" }}>
                Nous avons créé Éstiam pour délivrer une formation en
                informatique innovante avec des méthodes et un enseignement
                professionnalisant. Grâce à des effectifs réduits en classe,
                nous créons une relation individualisée entre chaque étudiant et
                nos formateurs.
              </Typography>
            </Box>
          </Grid>
...
//             }}
//           >
//             Réinitialisation d'identifiant
//           </Typography>
//           <Typography style={{ color: "#02B875", fontWeight: "bold" }}>
//             Un email de réinitialisation vous a été envoyé dans votre boîte
//             de réception
//           </Typography>
//           <Button
//             variant="outlined"
